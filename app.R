...
server <- function(input, output, session) {
  ...
  #       
  #       fluidPage(
  #         checkboxInput("changes_or_levels", "Levels?", value = T)
  #         
  #         # TODO tickbox indicating changes or levels (which only can be toggled if housing is selected)
  #         # TODO data source drop down (housing, income, wealth, consumption)
  #       ),
  #       
  #       footer = tagList(
  #         modalButton("Done")
  ...
  # }
  # 
  # observeEvent(input$changes_or_levels,{
  #   print(paste0("Levels?: ",input$changes_or_levels))
  # })
  # 
